...
def tests(session):
    ...
    try:
        ...
        session.run(
            ...
            "--omit=src/saltext/credstash/*",
            "--include=tests/*",
        )
        try:
            session.run("coverage", "report", "--show-missing", "--include=src/saltext/credstash/*")
            ...
            #    "--include=src/saltext/credstash/*,tests/*"
            # )
        finally:
